...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::middleware(['admin.check'])->group(
        function () {
            ...
            Route::get('goals/{goal}/tasks', [TaskController::class, 'index'])->name('task.index');
            Route::post('goals/{goal}/tasks', [TaskController::class, 'store'])->name('task.store');
            Route::get('goals/{goal}/reviews', [ReviewController::class, 'index'])->name('review.index');
            Route::post('goals/{goal}/reviews', [ReviewController::class, 'store'])->name('review.store');
            Route::middleware(['goal.ownership'])->group(
                function () {
